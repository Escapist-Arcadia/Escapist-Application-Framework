...
#include"EspThreeStateButton.h"

class EspAutoThreeStateButton :public EspThreeStateButton
{
public:
	virtual bool Create(
		LPCTSTR window_name,
	...
	)
	{
		handle = ::CreateWindowEx(
			...
			WC_BUTTON,
			window_name,
			WS_CHILD | WS_VISIBLE | BS_NOTIFY | BS_PUSHBUTTON |BS_PUSHLIKE| BS_AUTO3STATE | style,
